                            ...
                            <div style="display: flex; gap: 6px; align-items: center;">
                                ...
                                @else
                                    <button type="button" disabled
                                        ...
                                        title="No se puede editar en estado {{ $orden->estado }}">
                                        ✏️ Editar
                                    </button>
                                @endif
                            </div>
        ...
        <form id="edit-op-form" onsubmit="submitEditOPForm(event)" enctype="multipart/form-data">
            ...
            <div class="grid-2" style="margin-bottom:15px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="edit-numero-op" name="numero_op" class="form-control" required>
                </div>
            </div>
            <div class="grid-2" style="margin-bottom:15px;">
                <div class="form-group">
                    <label for="edit-proyecto">Proyecto / Campaña *</label>
                    <input type="text" id="edit-proyecto" name="proyecto" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="edit-presupuestista">Presupuestista *</label>
                    <input type="text" id="edit-presupuestista" name="presupuestista" class="form-control" required>
                </div>
            </div>
            <div class="grid-2" style="margin-bottom:15px;">
                <div class="form-group">
                    <label for="edit-cliente">Cliente *</label>
                    <input type="text" id="edit-cliente" name="cliente" class="form-control" required>
                </div>
                <div class="form-group">
                    <label for="edit-marca">Marca *</label>
                    <input type="text" id="edit-marca" name="marca" class="form-control" required>
                </div>
            </div>
            <div class="grid-2" style="margin-bottom:15px;">
                <div class="form-group">
                    <label for="edit-fecha-entrega" style="display:flex;align-items:center;gap:6px;">Fecha de Entrega <span style="background:rgba(255,166,0,0.15);color:#ffa600;border:1px solid rgba(255,166,0,0.3);border-radius:4px;font-size:0.7rem;padding:1px 6px;font-weight:700;">SOLO LECTURA</span></label>
                    <input type="date" id="edit-fecha-entrega" name="fecha_entrega_display" class="form-control" readonly style="opacity:0.6;cursor:not-allowed;background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.1);">
                </div>
                <div class="form-group">
                    <label for="edit-hora-entrega" style="display:flex;align-items:center;gap:6px;">Hora de Entrega <span style="background:rgba(255,166,0,0.15);color:#ffa600;border:1px solid rgba(255,166,0,0.3);border-radius:4px;font-size:0.7rem;padding:1px 6px;font-weight:700;">SOLO LECTURA</span></label>
                    <input type="time" id="edit-hora-entrega" name="hora_entrega_display" class="form-control" readonly style="opacity:0.6;cursor:not-allowed;background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.1);">
                </div>
            </div>
            ...
            <div class="form-group" style="margin-bottom:15px;">
                ...
                <select id="edit-entregar-a" name="entregar_a" required onchange="toggleEditInstalacionFields()">
            ...
            <div id="edit-instalacion-fields" class="installation-fields hidden">
                ...
                <div class="form-group" style="margin-bottom:12px;">
                    ...
                    <input type="text" id="edit-lugar-instalacion" name="lugar_instalacion" class="form-control">
                </div>
            ...
            <div class="form-group" style="margin-bottom:20px;">
                ...
                <p style="font-size:0.75rem;color:var(--text-muted);margin-top:5px;">Formatos: PDF, Excel, Word, PPT, ZIP, Imágenes, AI, PSD, CSV &nbsp;·&nbsp; Máx. 100 MB por archivo</p>
...
<script>
    ...
    function populateDetail(order) {
        ...
        // Show/hide the Editar OP button based on state and ownership
    ...
    function openEditOPModal(id) {
        ...
        .catch(err => {
            console.error('[Editar OP Vendedor]', err);
    ...
    function submitEditOPForm(event) {
        ...
        .then(({ ok, data }) => {
            ...
            // Refresh data from server (includes updated files)
            pollVendedorUpdates();
        })
        .catch(err => {
            console.error('[Editar OP submit Vendedor]', err);
            submitBtn.disabled    = false;
            submitBtn.textContent = '💾 Guardar Cambios';
